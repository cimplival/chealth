...
<TABLE STYLE="margin-left:-15px;" CELLPADDING=4 CELLSPACING=0>
	...
	<TR VALIGN=TOP>
		<TD WIDTH=145 STYLE="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0.04in; padding-left: 0.04in; padding-right: 0in; text-align:center;">
			<P>{{ $inpatient->patient->first_name }} {{ $inpatient->patient->middle_name }} {{ $inpatient->patient->last_name }} ({{ $inpatient->patient->med_id }})
			</P>
		</TD>
		<TD WIDTH=174 STYLE="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0.04in; padding-left: 0.04in; padding-right: 0in">
			<P ALIGN=LEFT>{{$inpatient->ward->ward_name}} Bed No: {{$inpatient->bed->bed_no}}
			</P>
		</TD>
		<TD WIDTH=97 STYLE="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0.04in; padding-left: 0.04in; padding-right: 0in; text-align:center;">
			<P>{{ Carbon\Carbon::parse($inpatient->created_at)->format('g:i a') }}
			</P>
		</TD>
		<TD WIDTH=85 STYLE="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-top: 0in; padding-bottom: 0.04in; padding-left: 0.04in; padding-right: 0.04in; text-align:center;">
			<P>
			@if(Carbon\Carbon::parse($inpatient->created_at)->diffInMinutes(Carbon\Carbon::parse($inpatient->updated_at)))
				@if(Carbon\Carbon::parse($inpatient->created_at)->diffInMinutes(Carbon\Carbon::parse($inpatient->updated_at))>2400)
					{{  Carbon\Carbon::parse($inpatient->created_at)->diffInDays(Carbon\Carbon::parse($inpatient->updated_at)) }} Days
				@elseif(Carbon\Carbon::parse($inpatient->created_at)->diffInMinutes(Carbon\Carbon::parse($inpatient->updated_at))>=60)
					{{ Carbon\Carbon::parse($inpatient->created_at)->diffInHours(Carbon\Carbon::parse($inpatient->updated_at)) }} Hours
				@else
					{{ Carbon\Carbon::parse($inpatient->created_at)->diffInMinutes(Carbon\Carbon::parse($inpatient->updated_at)) }} Minutes
				@endif
			@else
				N/A
			@endif
