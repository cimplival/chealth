<div class="col-md-7 col-md-offset-5">           
          <div class="list-group list-group-lg list-group-sp">
            ...
            <span class="list-group-item clearfix">
              <span class="clear">
                <span class="text-muted">On {{ Carbon\Carbon::parse($activity->created_at)->toDayDateTimeString() }}</span>
                <small class="clear"><strong>You</strong> {{ $activity->description }}</small>
              </span>
            </span>
            @endforeach
            </div>
