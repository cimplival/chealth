        ...
        <div class="panel-body">
          <div class="clearfix text-center ">
            <div class="inline">
              ...
              <div class="h5 m-t m-b-xs">{{$patient_original->first_name}} {{$patient_original->middle_name}} {{$patient_original->last_name}}</div>
            </div>                      
          </div>
        </div>
          ...
          <div class="row no-gutter">
            <div class="col-xs-6">
              <div class="wrapper">
                ...
                <small class="text-muted">{{$patient_original->med_id}}</small>
              </div>
            </div>
            <div class="col-xs-6 dk">
              <div class="wrapper">
                <span class="m-b-xs h6 block text-white">Created On</span>
                <small class="text-muted">{{ \Carbon\Carbon::parse($patient_original->created_at)->toFormattedDateString() }}</small>
              </div>
            </div>
          </div>
        </footer>
