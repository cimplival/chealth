...
<html lang="en" class="bg">
  <head>
    <meta charset="utf-8" />
    <title>cHealth / Access Denied - 403</title>
          ...
          <div class="hbox hbox-auto-xs hbox-auto-sm" ng-init="
            ...
            <div class="col">
              ...
              <div class="wrapper" ng-controller="FlotChartDemoCtrl">
                <!-- stats -->
                <div class="row">
                  <div class="col-md-12 text-center">Sorry, looks like there has been an exception error due to the login for expiring. Please go back and login again.</div>
                  <div class="text-center m-b-lg col-md-12">
                    <h1 class="text-shadow text-white">Form Expired</h1>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4 col-md-offset-4">
                    <a href="{{route('home-redirect')}}" class="btn m-b-xs btn-info btn-addon btn-md center-block">
                      Okay, go back and Login again.
                    </a>
                  </div>
                </div>
              </div>
