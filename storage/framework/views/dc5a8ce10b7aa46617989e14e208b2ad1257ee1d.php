            ...
            <table class="table table-hover table-sm table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($settings->currency); ?> <?php echo e($payment->service->cost); ?>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm-10 col-md-offset-1 text-center">
                                                    <p>Confirm cash payment of <i class="fa fa-money"></i> <strong> <?php echo e($settings->currency); ?> <?php echo e($payment->cost); ?></strong> for <strong><?php echo e($payment->patient->first_name); ?> <?php echo e($payment->patient->middle_name); ?> <?php echo e($payment->patient->last_name); ?></strong>?</p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10 col-md-offset-1 text-center">
                                                        <p>Confirm insurance payment for
                                                           <strong><?php echo e($payment->patient->first_name); ?> <?php echo e($payment->patient->middle_name); ?> <?php echo e($payment->patient->last_name); ?></strong> of <strong><?php echo e($payment->cost); ?></strong>.</p>
