                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 col-md-offset-2">
                                                        ...
                                                        <select name="service_id" class="form-control m-b" required>
                                                            ...
                                                            <option value="<?php echo e($service->id); ?>"><?php echo e(\App\Provider::where('id', $service->provider_id)->value('name')); ?> — <?php echo e($service->service_name); ?> (Ksh. <?php echo e($service->cost); ?>)</option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div><br>
                                                    <div class="col-md-8 col-md-offset-2">
