...
<?php $__env->startSection('main-header'); ?>
	<?php echo $__env->make('templates.admin.main-header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('doctor-blocks'); ?>
	<?php echo $__env->make('templates.admin.blocks', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
