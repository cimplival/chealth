...
<div class="row">
    <div class="col-md-12">         
        <div class="list-group list-group-lg list-group-sp">
            <?php echo Form::open(array('route' => 'search-activities')); ?>
            ...
            <div class="text-white" style="overflow:scroll; height:400px;">
                ...
                <span class="list-group-item bg-white dker">
                    <span class="clear">
                        <span><?php echo e(\Carbon\Carbon::parse($activity->created_at)->format('l jS \\of F Y h:i:s A')); ?></span><br>
                        <small>
                            <?php if(Auth::user()->hasRole('administrator')): ?>
                            <?php echo e($activity->users->full_name); ?>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12 wrapper-lg">
                                            ...
                                            <?php echo Form::open(['method'=>'POST','action'=>['Reports\ReportsController@exportDailyActivity']]); ?>
                                        ...
                                        <div class="col-md-12 wrapper-lg">
                                            ...
                                            <?php echo Form::open(['method'=>'POST','action'=>['Reports\ReportsController@exportMonthlyActivity']]); ?>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12 wrapper-lg">
                                            ...
                                            <?php echo Form::open(['method'=>'POST','action'=>['Reports\ReportsController@exportDailyUserActivity']]); ?>
                                        ...
                                        <div class="col-md-12 wrapper-lg">
                                            ...
                                            <?php echo Form::open(['method'=>'POST','action'=>['Reports\ReportsController@exportMonthlyUserActivity']]); ?>
