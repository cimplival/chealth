...
<?php $__env->startSection('main-header'); ?>
	<?php echo $__env->make('templates.pharmacy.main-header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('doctor-blocks'); ?>
	<?php echo $__env->make('templates.pharmacy.blocks', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
