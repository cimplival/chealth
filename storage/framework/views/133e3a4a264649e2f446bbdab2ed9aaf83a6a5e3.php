          ...
          <div class="row text-center">
            <div class="col-md-10 col-md-offset-1">
              ...
              <select id="services_all" name="service_id" class="form-control m-b" required>
                ...
                <option value="<?php echo e($service->id); ?>"><?php echo e($service->provider->name); ?> - <?php echo e($service->service_name); ?> (<?php echo e($settings->currency); ?> <?php echo e($service->cost); ?>)</option>
                <?php endforeach; ?>
              </select>
