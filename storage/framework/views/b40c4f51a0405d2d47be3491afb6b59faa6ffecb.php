...
<?php $__env->startSection('reception-header-home'); ?>
	<?php echo $__env->make('templates.reception.reception-header-home', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('reception-home-blocks'); ?>
	<?php echo $__env->make('templates.reception.reception-home-blocks', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
