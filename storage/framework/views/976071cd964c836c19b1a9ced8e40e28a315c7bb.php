															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h2 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-bottom:0px;text-align:center;"><?php echo e($hospital->name_of_institution); ?>
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Dear <?php echo e($patient->first_name); ?>,</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;"><?php echo e($email_message); ?><br><br>
																					Best Regards,<br> <?php echo e($hospital->name_of_institution); ?></div>
																				</td>
																			</tr>
																		</table>
																		<!-- // CONTENT TABLE -->
																	...
																	<td align="center" valign="top">
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div><a href="<?php echo e($hospital->website); ?>" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;"><?php echo e($hospital->name_of_institution); ?></span></a><br>Copyright &#169;<?php echo date("Y"); ?>. All&nbsp;rights&nbsp;reserved. </div>
																		</div>
																				</td>
																			</tr>
																		</table>
