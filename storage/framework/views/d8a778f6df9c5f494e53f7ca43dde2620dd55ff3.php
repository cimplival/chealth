...
<?php $__env->startSection('aside'); ?>
<?php echo $__env->make('templates.vitals.aside', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
<?php endif; ?>
		...
		<div class="panel-body">
			<form role="form" method="POST" action="<?php echo e(url('change-password')); ?>"><?php echo e(csrf_field()); ?>
				...
				<div class="form-group text-center">
					<button type="submit" class="btn m-b-xs btn-sm btn-primary pull-right">Change Password</button>
				</div>
			</form>
		</div>
	</div>
