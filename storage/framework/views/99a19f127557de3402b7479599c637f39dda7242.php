...
<?php $__env->startSection('header-appointments'); ?>
	<?php echo $__env->make('templates.pharmacy.header-dispensations', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('main-header'); ?>
	<?php echo $__env->make('templates.pharmacy.main-header-dispensations', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('doctor-appointments-body'); ?>
	<?php echo $__env->make('templates.pharmacy.dispensations-body', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
